...
RUN echo "deb http://cran.rstudio.com/bin/linux/debian stretch-cran34/" >> /etc/apt/sources.list \
  && apt-get update \
  && apt-get -y --allow-unauthenticated install build-essential python3-dev python3-setuptools python3-numpy python3-scipy libatlas-dev libatlas3-base python3-pip \
